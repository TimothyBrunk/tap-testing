...
from tap_rest_api_msdk.utils import flatten_json, get_current_time
...
class DynamicStream(RestApiStream):
    ...
    def __init__(self,
        ...
        self.name = name
        self.use_dynamic_timestamp = use_dynamic_timestamp
        self.path = path
        self.params = params
    ...
    def get_url_params(self, context: Optional[dict], next_page_token: Optional[Any]) -> Dict[str, Any]:
        ...
        if self.params:
            for k, v in self.params.items():
                params[k] = v
        if self.use_dynamic_timestamp:
            print("YES USE DYNAMIC")
            params["createdAfter"] = get_current_time()
        if next_page_token:
