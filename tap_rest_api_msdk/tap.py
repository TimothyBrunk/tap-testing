...
class TapRestApiMsdk(Tap):
    ...
    config_jsonschema = th.PropertiesList(
        ...
        th.Property('use_dynamic_timestamp', th.BooleanType, default=False, required=False,
                    description="If enabled, this setting plugs in the current date to the Echosec API url."),
        th.Property('name', th.StringType, required=True,
                    description="name of the stream"),
        th.Property('path', th.StringType, default="", required=False,
                    description="the path appended to the `api_url`."),
    ...
    def discover_streams(self) -> List[Stream]:
        ...
        return [
            DynamicStream(
                ...
                use_dynamic_timestamp=self.config.get('use_dynamic_timestamp')
            )
        ]
